...
import com.events.SpeechReadyEvent;
...
public class SpeechHandler {
    ...
    public function hasSpeech():Boolean {
        return _speeches.length > 0 || criticalSpeeches.length > 0;
    }
...
//        trace("speeches length", _speeches.length, "critical speeches length", criticalSpeeches.length)
        ...
        speech.addEventListener(SpeechReadyEvent.SPEECH_READY, speechPlayReady);
    ...
    private function speechPlayReady(e:SpeechReadyEvent):void {
        _nowPlaying = false;
        playSpeeches();
    }
