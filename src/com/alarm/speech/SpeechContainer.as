...
//    [Embed(source="../../../assets/speech/kevlin.mp3")]
//    internal static var _kevlin:Class;
...
//    internal static var _AIS_Vessel_will_be_in:Class;
    ...
    public static var container:Object = {
        "0": Assets.assets.getSound("0"),
        "1": Assets.assets.getSound("1"),
        "2": Assets.assets.getSound("2"),
        "3": Assets.assets.getSound("3"),
        "4": Assets.assets.getSound("4"),
        "5": Assets.assets.getSound("5"),
        "6": Assets.assets.getSound("6"),
        "7": Assets.assets.getSound("7"),
        "8": Assets.assets.getSound("8"),
        "9": Assets.assets.getSound("9"),
        "10": Assets.assets.getSound("10"),
        "11": Assets.assets.getSound("11"),
        "12": Assets.assets.getSound("12"),
        "13": Assets.assets.getSound("13"),
        "14": Assets.assets.getSound("14"),
        "15": Assets.assets.getSound("15"),
        "16": Assets.assets.getSound("16"),
        "17": Assets.assets.getSound("17"),
        "18": Assets.assets.getSound("18"),
        "19": Assets.assets.getSound("19"),
        "20": Assets.assets.getSound("20"),
        "30": Assets.assets.getSound("30"),
        "40": Assets.assets.getSound("40"),
        "50": Assets.assets.getSound("50"),
        "60": Assets.assets.getSound("60"),
        "70": Assets.assets.getSound("70"),
        "80": Assets.assets.getSound("80"),
        "90": Assets.assets.getSound("90"),
        "100": Assets.assets.getSound("100"),
        "200": Assets.assets.getSound("200"),
        "300": Assets.assets.getSound("300"),
        "400": Assets.assets.getSound("400"),
        "500": Assets.assets.getSound("500"),
        "600": Assets.assets.getSound("600"),
        "700": Assets.assets.getSound("700"),
        "800": Assets.assets.getSound("800"),
        "900": Assets.assets.getSound("900"),
        "windspeedis": Assets.assets.getSound("wind_speed_is_"),
        "waterdepthis": Assets.assets.getSound("water_depth_is_"),
        "watertemperatureis": Assets.assets.getSound("water_temperature_is_"),
        "boatspeedis": Assets.assets.getSound("boat_speed_is_"),
        "currentdepthis": Assets.assets.getSound("current_depth_is_"),
        "shipistooclose": Assets.assets.getSound("ship_is_too_close_"),
        "windangleis": Assets.assets.getSound("wind_angle_is_"),
        "knots": Assets.assets.getSound("knots"),
        "milesperhour": Assets.assets.getSound("miles_per_hour"),
        "kilometerperhour": Assets.assets.getSound("kilometer_per_hour"),
        "meterpersecundum": Assets.assets.getSound("meter_per_secundum"),
        "nauticalmile": Assets.assets.getSound("nautical_mile"),
        "beaufort": Assets.assets.getSound("beaufort"),
        "mile": Assets.assets.getSound("mile"),
        "kilometer": Assets.assets.getSound("kilometer"),
        "meter": Assets.assets.getSound("meter"),
        "degree": Assets.assets.getSound("degree"),
        "feet": Assets.assets.getSound("feet"),
        "fathom": Assets.assets.getSound("fathom"),
        "point": Assets.assets.getSound("point"),
        "percent": Assets.assets.getSound("percent"),
        "celsius": Assets.assets.getSound("celsius"),
        "fahrenheit": Assets.assets.getSound("fahrenheit"),
        "kelvin": Assets.assets.getSound("kelvin"),
        "waterdepthchangeddramatically": Assets.assets.getSound("water_depth_changed_dramatically"),
        "windchangeddramatically": Assets.assets.getSound("wind_changed_dramatically"),
        "watertemperaturechangeddramatically": Assets.assets.getSound("water_temperature_changed_dramatically"),
        "noconnection": Assets.assets.getSound("no_connection"),
        "nodata": Assets.assets.getSound("no_data"),
        "notvalid": Assets.assets.getSound("not_valid"),
        "crosstrackerroris": Assets.assets.getSound("cross_track_error_is"),
        "minus": Assets.assets.getSound("minus"),
        "anchor": Assets.assets.getSound("anchor"),
        "winddirectionshiftis": Assets.assets.getSound("wind_direction_shift_is"),
        "waypointdistanceis": Assets.assets.getSound("waypoint_distance_is"),
        "performanceis": Assets.assets.getSound("performance_is"),
        "offcourseis": Assets.assets.getSound("off_course_is"),
        "AISVesselwillbein": Assets.assets.getSound("AIS_Vessel_will_be_in")
    };
