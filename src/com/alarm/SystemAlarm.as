...
public class SystemAlarm extends Alarm {
    ...
    public override function isValidValue():Boolean {
        if (_alarmType === KEY_VALIDATION) {
            return (SocketDispatcher.instance.getStatus() == 1 && (SailData.actualSailData.sailDataTimestamp - _lastTimestamp) > _threshold)
        } else {
...
//                return false;
//            }
            return SocketDispatcher.instance.getStatus() < 1;
        }
    }
