...
public class PolarListItem extends ListItem {
    ...
    private function onSelect(event:TouchEvent):void {
        if(touchIsEnd(event)) {
            activate();
    ...
    private function onPolarFileLoaded(event:Event):void {
...
//        _active = true;
    ...
    private function onPolarFileWarning(event:Event):void {
        EdoMobile.polarLoadingScreen.visible = false;
