...
public class AisContainer extends EventDispatcher {
    ...
    public function AisContainer() {
        ...
        ownShip = new OwnShip();
        ownShip.addEventListener("heading-changed", ownShipHeadingChangedHandler);
        ownShip.addEventListener("timestamp-changed", ownShipTimestampChangedHandler);
        ownShip.addEventListener("coordinate-changed", ownShipCoordinateChangedHandler);
        ownShip.addEventListener("speed-changed", ownShipSpeedChangedHandler);
    }
