...
public class AES {
     ...
     */
    public static function encrypt(_InPlainData:String, key:String, iv:String):String {
        ...
        returnIVandData.push(Base64.encodeByteArray(ivdata));
        returnIVandData.push(Base64.encodeByteArray(data));
        return returnIVandData.join("$");
    }
