...
public class SignSettings extends Sprite {
    ...
    private static var _emailInput:TextInput;
    private static var _passwordLabel:TextField;
    private static var _passwordInput:TextInput;
    ...
    private function onEmailFocus(event:Event):void {
        EdoMobile.menu.to(-(EdoMobile.menu.signY + _emailLabel.y));
    }

    private function onPasswordFocus(event:Event):void {
    ...
    private function onStatusChange(event:PolarHandlerEvent):void {
        setLed();
    }

    private function onSignIn(event:TouchEvent):void {
        if(_signInBtn.touchIsEnd(event)) {
    ...
    private function onSignOut(event:TouchEvent):void {
        if(_signOutBtn.touchIsEnd(event)) {
