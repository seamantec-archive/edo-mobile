...
public class DigitalA extends BaseDigital {

    public function DigitalA() {
    ...
    protected override function buildComponents():void {
        ...
        backgroundBatch = new InstrumentQuadBatcher(background.width,background.height, "digitalBackgroundA");
