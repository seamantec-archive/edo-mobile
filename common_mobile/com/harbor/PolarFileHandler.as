   ...
   // private var _selectStatement:SQLStatement = new SQLStatement();
    ...
    private function removeDeletedPolars(ids:Vector.<String>):void {
        ...
        for (var i:int = 0; i < ids.length; i++) {
            ...
            try {
                removedItem.getFile().deleteFile();
            } catch (e:Error) {
...
//        SystemLogger.Debug("Can't open polars db!" + e.error);
//        _dbReady = false;
//    }

//    private function createStatement_resultHandler(e:SQLEvent):void {
//        //trace("create ok")
//        //_dbReady = true;
//        var createStatement:SQLStatement = new SQLStatement();
//        createStatement.sqlConnection = _sqlConnection;
...
//    private function createVersionStatement_resultHandler(e:SQLEvent):void {
//        //trace("create version ok");
//        runMigrations();
//    }

//    private function selectVersionStatement_resultHandler(e:SQLEvent):void {
...
//    private function migrationStatement_resultHandler(e:SQLEvent):void {
//        //trace("migration ok");
...
//    }
//
//    private function insertMigrationStatement_resultHandler(e:SQLEvent):void {
//        //trace("insert migration ok");
//        _dbReady = true;
//
//    }
//
//    private function createStatement_errorHandler(e:SQLErrorEvent):void {
//        trace("create error", e.error);
//    }
//
//    private function createVersionStatement_errorHandler(e:SQLErrorEvent):void {
//        trace("create version error", e.error);
//    }
//
//    private function selectVersionStatement_errorHandler(e:SQLErrorEvent):void {
//        trace("select version error", e.error);
//    }
//
//    private function migrationStatement_errorHandler(e:SQLErrorEvent):void {
//        trace("migration error", e.error);
//    }
//
//    private function insertMigrationStatement_errorHandler(e:SQLErrorEvent):void {
//        trace("insert migration error", e.error);
//    }
...
//    private function deleteStatement_resultHandler(e:SQLEvent):void {
...
//        //TODO dispatch e, or call logbookdatahandler method
//    }
//
//    private function deleteStatement_errorHandler(e:SQLErrorEvent):void {
//        var statement:SQLStatement = (e.currentTarget as SQLStatement);
//        statement.removeEventListener(SQLEvent.RESULT, deleteStatement_resultHandler);
//        statement.removeEventListener(SQLErrorEvent.ERROR, deleteStatement_errorHandler);
//    }
...
//    private function counterStatement_resultHandler(ev:SQLEvent):void {
//        try {
//
//        } catch (e:Error) {
//
