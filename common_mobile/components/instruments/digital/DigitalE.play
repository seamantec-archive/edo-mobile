...
public class DigitalE extends BaseDigital {

    public function DigitalE() {
        super(Assets.getInstrument("digital_e"));
    }
    ...
    protected override function buildComponents():void {
        ...
        backgroundBatch = new InstrumentQuadBatcher(background.width,background.height, "digitalBackgroundE");
