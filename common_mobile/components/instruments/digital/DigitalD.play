...
public class DigitalD extends BaseDigital {

    public function DigitalD() {
        super(Assets.getInstrument("digital_d"));
    }
    ...
    protected override function buildComponents():void {
        ...
        _instrumentAtlas.getTextFieldComponentWithParent(basic, "digital.digimin1", digital, background, VAlign.CENTER, HAlign.RIGHT, 1, 0xffeea3);
        _instrumentAtlas.getTextFieldComponentWithParent(basic, "digital.digimax1", digital, background, VAlign.CENTER, HAlign.RIGHT, 1, 0xffeea3);
        _instrumentAtlas.getTextFieldComponentWithParent(basic, "digital.digi1", digital, background);
        ...
        backgroundBatch = new InstrumentQuadBatcher(background.width,background.height, "digitalBackgroundD");
