...
//			}
		...
		public override void Update ()
		{
			...
			if (mStage == null) {
				...
				nfloat nativeScale = UIScreen.MainScreen.NativeScale;
				nfloat scale = UIScreen.MainScreen.Scale;
				mStage = new flash.display.Stage ((int)screenNativeBounds.Width, (int)screenNativeBounds.Height);
				Console.WriteLine (mStage.width + " " + mStage.height);
			}


			if (mEdoStartup == null) {
				// construct starling demo
				flash.display.DisplayObject.constructorStage = mStage;
				mEdoStartup = new _root.EdoStartup ();
				flash.display.DisplayObject.constructorStage = null;
			}
			if (mStage != null) {
				mStage.onEnterFrame ();
//				var te = new flash.events.Event (flash.events.Event.ENTER_FRAME, true, false);
//				if (mStage != null)
